  ...
  return (
    <>
      ...
      <div className=" w-screen pt-5 pb-5 bg-secondaryBlue">
        <h1 className="text-center text-fsHero text-primaryWhite">
          Agregar vehículo
        </h1>
        <form
          className="w-[90%] grid grid-cols-2 gap-5 mx-auto  p-10"
          id="form"
          onSubmit={handleSubmit}
        >
          <div className="flex items-center justify-around gap-5">
            <span className="w-1/2 bg-primaryGold text-primaryWhite rounded-md text-center py-[14px]">
              marca
            </span>
            <Input
              className="w-1/2"
          ...
          <div className="flex items-center justify-around gap-5 ">
            ...
            <input
              className="w-1/2 text-primaryWhite"
              name="imagenes"
              type="file"
              multiple
              size="md"
          ...
          <div className="flex mt-10 col-span-2 ">
            <Button
              className="w-1/4 mx-auto bg-primaryBlue text-primaryWhite"
              size="lg"
              type="submit"
            >
              {isLoading ? <Spinner /> : "confirmar vehiculo"}
            </Button>
          </div>
        </form>
      </div>
